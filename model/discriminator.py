...
class Discriminator(nn.Module):
  ...
  def __init__(self, bias = False):
    ...
    self.net = nn.Sequential(ConvNormLRelu(3, 32, 3, 1, 2, 1, bias),
                             ConvNormLRelu(32, 1, 32, 3, 1, 2, 1, bias),
                             ConvNormLRelu(32, 1, 64, 3, 1, 2, 1, bias),
                             ConvNormLRelu(64, 1, 64, 3, 1, 2, 1, bias),
                             ConvNormLRelu(64, 1, 128, 3, 1, 2, 1, bias),
                             ConvNormLRelu(128, 1, 128, 3, 1, 2, 1, bias),
